  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/face.jpeg" alt="Logoipsum" style={{borderRadius: '50%', width: '50px', height: '50px', objectFit: 'cover'}}/>
        </div>
          ...
          <ul>
            <li>
              ...
              >
                ...
                >
                  <path
                    d="M19.006 15.003L27.359 5.25H25.38L18.127 13.738L12.333 5.25H5.667L14.453 18.113L5.667 28.395H7.646L15.331 19.4L21.492 28.395H28.158L19.005 15.003ZM16.296 18.174L15.409 16.896L8.358 6.732H11.398L17.087 14.93L17.974 16.208L25.381 26.882H22.341L16.296 18.175V18.174Z"
                    fill="black"
                  />
                </svg>
              </a>
            ...
            <li>
              <a
                href="https://www.instagram.com/dulatulyn"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/dulatulyn"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with ❤️ by Nurasyl</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
